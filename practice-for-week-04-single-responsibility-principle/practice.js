...
const total = (costOfPie , pieQuantity) => costOfPie * pieQuantity//total Price of a pie

const totalRevenue = (totalCost, profitMargin) => totalCost * (profitMargin || 1.2)// total Revenue generated
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  const totalCost = total(costOfPie, pieQuantity);
